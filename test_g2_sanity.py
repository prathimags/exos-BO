...
def test_update_policy_image_and_checkstatus():
    ...
    for sn in snsList:
        ...
        policyupdatestatus=CheckPolicyStatusPeriodic(apiurl=apiurl,authurl=authurl,xiquser=xiquser,xiqpass=xiqpass,sn=sn,auth_token=auth_token,starttime=30,incrementtime=15,endtime=600)
